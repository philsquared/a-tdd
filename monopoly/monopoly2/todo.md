...
2. Add a `Dice` class with a `roll()` method (use random_number.h). Remember that "dice" is plural, and in Monopoly there are two. Remember to drive it through tests.
