...
4. There's a report that the tests are failing when logging at Debug level. Reproduce the issue, find and fix.
...
* Remember you need to include Google Mocks for the exception matchers
